...
<?php if (!empty($data['std']) and $isShow>0 and $isShow!=8){ ?>			
	...
	<script type="text/javascript">
    	function show_coords(evt){
			...
			var $minB1 = 15000;
			var $minB2 = 12750;
			var $ratioB = $minB2/$minB1 - ($minB2/$minB1-$maxB2/$maxB1)/($maxB1-$minB1)*(value1-$minB1);
			var $new_valueB = Math.round(value1*$ratioB,0);
			//alert(new_valueB);
			say.innerHTML = "0.82:" + value + ",旧:" + new_value + ",新:" + $new_valueB;
	...
	<div onmousemove="show_coords(event)" onmouseout="clear_coords()" class="Histogram">
		<div id="coords" style="width: 35%"></div>
